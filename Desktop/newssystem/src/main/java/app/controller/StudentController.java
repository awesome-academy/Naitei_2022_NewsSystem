...
public class StudentController {
	...
	public String createStudent(@Valid @ModelAttribute Student studentForm, BindingResult bindingStudent,
			final RedirectAttributes redirectAttributes) {
		logger.info("create student");

		if (bindingStudent.hasErrors() || bindingStudent.hasErrors()) {
			return "views/students/student-form";
		}

		Student newStudent = studentService.saveOrUpdate(studentForm);
		if (newStudent == null) {

			redirectAttributes.addFlashAttribute("css", "danger");
			redirectAttributes.addFlashAttribute("msg", "Create student fail");
		} else {
			redirectAttributes.addFlashAttribute("css", "success");
			redirectAttributes.addFlashAttribute("msg", "Create student success");
		}
